...
import '@opendrome/v3-core/contracts/interfaces/callback/IOpendromeV3FlashCallback.sol';
import '@opendrome/v3-core/contracts/libraries/LowGasSafeMath.sol';
...
/// @notice An example contract using the Opendrome V3 flash function
contract PairFlash is IOpendromeV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `OpendromeV3FlashCallback`
